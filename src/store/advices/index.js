        ...
        async postData(_, payload) {
            ...
            if (payload.covid_questions.had_covid === 'yes') {
                ...
                if (data.had_antibody_test) {
                    if (payload.covid_questions.antibodies.test_date !== '',payload.covid_questions.antibodies.number!==null ) {
                        data.antibodies = {test_date: payload.covid_questions.antibodies.test_date,number:payload.covid_questions.antibodies.number}
                    }
